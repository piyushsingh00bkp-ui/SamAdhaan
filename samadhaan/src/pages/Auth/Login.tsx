      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-stone-200 dark:border-slate-800 shadow-xl transition-colors">
          <div className="flex items-center justify-between mb-1">
            <h1 className="text-xl font-bold text-stone-900 dark:text-white">Sign in to Portal</h1>
            <span className="text-[11px] font-bold text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
              Secure Gateway
            </span>
          </div>
          <p className="text-xs text-stone-500 mb-6 font-normal">Access live issue tracking, university R&D & CSR desk</p>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-stone-300 dark:border-slate-700 bg-stone-50 dark:bg-slate-800 hover:bg-stone-100 dark:hover:bg-slate-700 text-xs font-bold text-stone-800 dark:text-slate-200 transition-all mb-4 cursor-pointer shadow-xs"
          >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label className="text-xs font-bold text-stone-700 dark:text-slate-300 mb-1.5 block uppercase tracking-wider">Password</label>
